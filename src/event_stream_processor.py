...
from .event_stream_producer import EventStreamProducer


# from kafka import KafkaConsumer, KafkaProducer

# this is a consumer producer connected system

class EventStreamProcessor(EventStreamConsumer, EventStreamProducer):
